...
<table width="100%" height="204" border="0">
  <tr>
    <td height="31" colspan="3" bordercolor="#000000" bgcolor="#E9F0F8"><div align="center"><strong>Upload Documents/Images/Video's </strong></div></td>
  </tr>
  ...
  <tr>
    ...
    <td><label>
      ...
      <br>
    Images Should be in .jpg , .gif , .png formats<br>
    Documents should be in .doc , .docx , .pdf , .html formats<br>
    video should be in .wma format
</label></td>
  </tr>
  <tr>
    <td colspan="3" bgcolor="#E9F0F8"><label>
      <div align="right">
        ...
        <input name="up_file_bt" type="submit" id="up_file_bt" value="Upload File" />
