...
<html>
<head>
<title>Entrepreneur Information</title>
...
<form action="ent_change.php" method="post">
  ...
  <div align="left">
    <table width="675" height="454" border="1"  align="center" bgcolor="#FFffff">	
      <tr>
        <td colspan="3" bordercolor="#000000" bgcolor="#C9DBED"><h2 align="center">Entrepreneur Information's 
      </h2>
        <tr>
	...
	<?php echo $v[3]; ?>
      ...
      <tr>
          <td colspan="3" bgcolor="#C9DBED"><div align="center"><strong>Contact Details </strong>          </div>
      <tr>
